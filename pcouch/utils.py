...
def conectar():
    ...
    # conn = couchdb.Server("http://couchdb:5984/")
...
def listar():
    ...
    if db:
        ...
        print(f"Não foi possível listar os produtos.")
...
def inserir():
    ...
    if db:
        ...
        if res:
            ...
            print(f"Não foi salvo o produto.")
            
    else:
        print(f"Não foi possível conectar o produto.")
